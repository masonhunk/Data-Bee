...
数据导出组件WeBankBlockchain-Data-Beee的目的在于降低获取区块链数据的开发门槛，提升研发效率。研发人员几乎不需要编写任何代码，只需要进行简单配置，就可以把数据导出到Mysql数据库。
...
- [提问和提交BUG](https://github.com/WeBankBlockchain/Data-Bee/issues)。
