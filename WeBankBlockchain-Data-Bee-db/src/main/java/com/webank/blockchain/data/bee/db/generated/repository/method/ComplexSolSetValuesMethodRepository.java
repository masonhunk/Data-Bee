...
import com.webank.blockchain.data.bee.db.generated.entity.method.ComplexSolSetValues;
import com.webank.blockchain.data.bee.db.repository.RollbackInterface;


@Repository
public interface ComplexSolSetValuesMethodRepository extends JpaRepository<ComplexSolSetValues, Long>, JpaSpecificationExecutor<ComplexSolSetValues>, RollbackInterface {
	ComplexSolSetValues findByTxHash(String txHash);
