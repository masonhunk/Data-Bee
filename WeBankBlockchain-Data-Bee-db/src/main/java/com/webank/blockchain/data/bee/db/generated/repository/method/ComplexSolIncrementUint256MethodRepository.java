...
import com.webank.blockchain.data.bee.db.generated.entity.method.ComplexSolIncrementUint256;
import com.webank.blockchain.data.bee.db.repository.RollbackInterface;


@Repository
public interface ComplexSolIncrementUint256MethodRepository extends JpaRepository<ComplexSolIncrementUint256, Long>, JpaSpecificationExecutor<ComplexSolIncrementUint256>, RollbackInterface {
	ComplexSolIncrementUint256 findByTxHash(String txHash);
