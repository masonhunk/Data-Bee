...
import com.webank.blockchain.data.bee.db.entity.BlockDetailInfo;
...
public interface BlockDetailInfoRepository
    ...
    /*
     * @see com.webank.blockchain.data.bee.sys.db.repository.RollbackInterface#rollback(long)
     */
    @Transactional
    @Modifying
    ...
    /*
     * @see com.webank.blockchain.data.bee.sys.db.repository.RollbackInterface#rollback(long, long)
     */
    @Transactional
    @Modifying
