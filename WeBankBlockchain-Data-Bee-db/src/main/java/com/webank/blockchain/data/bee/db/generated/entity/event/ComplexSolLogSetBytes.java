...
@Entity(name = "complex_sol_log_set_bytes_event")
@Table(name = "complex_sol_log_set_bytes_event", indexes = { @Index(name = "block_height", columnList = "block_height"),
        @Index(name = "block_timestamp", columnList = "block_timestamp"),
        @Index(name = "tx_hash", columnList = "tx_hash")})
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class ComplexSolLogSetBytes extends IdEntity {
