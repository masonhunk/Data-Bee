...
import com.webank.blockchain.data.bee.db.generated.entity.method.ComplexSolSetBytesMapping;
import com.webank.blockchain.data.bee.db.repository.RollbackInterface;


@Repository
public interface ComplexSolSetBytesMappingMethodRepository extends JpaRepository<ComplexSolSetBytesMapping, Long>, JpaSpecificationExecutor<ComplexSolSetBytesMapping>, RollbackInterface {
	ComplexSolSetBytesMapping findByTxHash(String txHash);
