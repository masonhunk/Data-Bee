...
@Entity(name = "complex_sol_constructor_method")
@Table(name = "complex_sol_constructor_method", indexes = { @Index(name = "block_height", columnList = "block_height"),
        @Index(name = "block_timestamp", columnList = "block_timestamp"),
        @Index(name = "tx_hash", columnList = "tx_hash")})
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class ComplexSolConstructor extends IdEntity {
